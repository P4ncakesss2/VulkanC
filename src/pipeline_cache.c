                                 ...
                                 VkMaterial* mat, PipelineEntry* e)
{
    ...
    VkFormat colorFmt = cfg->colorFormat;
    ...
    VkSampleCountFlagBits samples = cfg->sampleCount != 0 ? cfg->sampleCount : b->msaaSamples;
    ...
    bool hasColor = colorFmt != VK_FORMAT_UNDEFINED;
    VkPipelineColorBlendStateCreateInfo cb = {
        .sType           = VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO,
        .attachmentCount = hasColor ? 1 : 0,
        .pAttachments    = hasColor ? &b->colorBlendAttachment : NULL,
    };
    VkPipelineRenderingCreateInfo rci = {
        .sType                   = VK_STRUCTURE_TYPE_PIPELINE_RENDERING_CREATE_INFO,
        .colorAttachmentCount    = hasColor ? 1 : 0,
        .pColorAttachmentFormats = hasColor ? &colorFmt : NULL,
