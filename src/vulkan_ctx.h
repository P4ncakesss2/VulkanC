...
typedef enum VulkanStatus {
    ...
    VULKAN_ERROR_COMMAND_BUFFER_ALLOCATION_FAILED = -25,
    VULKAN_ERROR_SEMAPHORE_CREATION_FAILED = -26,
    VULKAN_ERROR_FENCE_CREATION_FAILED = -27,
    VULKAN_ERROR_DESCRIPTOR_SET_LAYOUT_CREATION_FAILED = -28,
    VULKAN_ERROR_DESCRIPTOR_POOL_CREATION_FAILED = -29,
    VULKAN_ERROR_DESCRIPTOR_SET_ALLOCATION_FAILED = -30,
    VULKAN_ERROR_BUFFER_CREATION_FAILED = -31,
    VULKAN_ERROR_IMAGE_CREATION_FAILED = -32,
    VULKAN_ERROR_MEMORY_ALLOCATION_FAILED = -33
} VulkanStatus;
